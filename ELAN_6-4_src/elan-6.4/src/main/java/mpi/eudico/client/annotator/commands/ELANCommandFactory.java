...
public class ELANCommandFactory {
	...
	/* four frame rate related menu options */
    ...
    public static final String EXPORT_JSON_TO_SERVER = "Menu.File.ExportToServer.JSON";
	...
	public static CommandAction getCommandAction(Transcription tr, String caName) {
		...
		if (ca == null) {
			...
			else if (caName.equals(EXPORT_JSON_TO_SERVER)) {
                ca = new ExportJSONToServerCA(viewerManager);
            }
			else if (caName.equals(LIST_IDS_FROM_SERVER)) {
			...
			else if (caName.equals(SET_CUSTOM_MS_PER_FRAME)) {
				ca = new SetCustomMsPerFrameCA(viewerManager);
			}
			else if (caName.equals(MODIFY_ANNOTATION_RESOURCE_URL)) {
	...
	public static Command createCommand(Transcription tr, String cName) {
        ...
        else if (cName.equals(EXPORT_JSON_TO_SERVER)) {
        	c = new ExportJSONToServerCommand(cName);
        }
        else if (cName.equals(LIST_IDS_FROM_SERVER)) {
		...
		else if (cName.equals(SET_CUSTOM_MS_PER_FRAME)) {
			c = new SetCustomMsPerFrameCommand(cName);
		}
		else if (cName.equals(MODIFY_ANNOTATION_RESOURCE_URL_DLG)) {
			c = new ModifyAnnotationResourceURLDlgCommand(cName);
		}
		else if (cName.equals(MODIFY_ANNOTATION_RESOURCE_URL)) {
