...
//        long mediaOffset = 0L;
        ...
        if (transcription != null) {
            ...
            encInfoTrans.setIncludeCVDescription(includeCVEntryDesCB.isEnabled() &&
            		includeCVEntryDesCB.isSelected());
            ...
            encInfoTrans.setIncludeAnnotationId(includeAnnotationIdCB.isEnabled() &&
            		includeAnnotationIdCB.isSelected());
        	...
        	encInfoFiles.setIncludeCVDescription(includeCVEntryDesCB.isEnabled() &&
        			includeCVEntryDesCB.isSelected());
        	...
        	encInfoFiles.setIncludeAnnotationId(includeAnnotationIdCB.isEnabled() &&
        			includeAnnotationIdCB.isSelected());
