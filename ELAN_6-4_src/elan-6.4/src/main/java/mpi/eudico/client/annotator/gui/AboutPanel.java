...
public class AboutPanel extends JPanel {
    ...
    private JPanel getSoftwarePanel(){
    	...
    	StringBuilder textBuf = new StringBuilder("<html>");
    	textBuf.append("<b>This product includes resources and/or software developed by : </b> <br><br>");
    	textBuf.append("<ul><li><b>OpenJDK, Oracle</b> https://jdk.java.net and https://openjdk.java.net</li><br>");
    	...
    	textBuf.append("<li><b>RosettaCode</b> https://rosettacode.org/wiki/Rosetta_Code</li><br>");
    	textBuf.append("<li><b>ISO 639-3 Code Set</b> www.iso639-3.sil.org</li><br>");
    	textBuf.append("<li><b>FFmpeg</b> https://ffmpeg.org</li>");
    	textBuf.append("</ul>");
    	textBuf.append("For license and copyright information, please consult the file &quot;LICENSES.txt&quot; distributed with this product.<br><br>");
    	textBuf.append("</html>");
