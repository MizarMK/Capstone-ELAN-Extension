...
public class TimeLineViewer extends TimeScaleBasedViewer
    ...
    private boolean viewPortListenerEnabled = true;
...
//        int zoom = (int) (100f * (10f / msPerPixel));
        ...
        if (!viewPortMode && zoomSlider != null) {
...
alltierloop: 
	...
	public void stateChanged(ChangeEvent e) {
		if (e.getSource() == zoomSlider) {
			...
			//}
		} else if (e.getSource() == viewPort && viewPortListenerEnabled) {
...
*/
	...
	public void addNotify() {
		...
		if (getParent() instanceof JViewport) {
			...
			if (viewPort.getParent() instanceof JScrollPane) {
				((JScrollPane) viewPort.getParent()).addMouseWheelListener(this);
			}
			viewPortMode = true;
			imageWidth = viewPort.getExtentSize().width;
			imageHeight = viewPort.getExtentSize().height;
	...
	public Dimension getPreferredSize() {
		if (viewPortMode) {
			...
			return new Dimension((int) (
					(getMediaDuration() / msPerPixel) + (getViewWidth() / 2)), 
						h);
		}
